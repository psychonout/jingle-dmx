...
class AdaptiveThresholds:
    ...
    def update(self, volume: float) -> None:
        ...
        if self.ema_volume == 0:  # First update
            ...
            # Update EMA for volume
            self.ema_volume = (
                self.smoothing_factor * self.ema_volume
        ...
        new_min = max(5, base_threshold * 0.7)
...
def test_dynamic_thresholds():
    ...
    logger.info("Testing dynamic threshold systems...")
    ...
    for env_name, volume_gen in environments:
        ...
        for i in range(100):
            ...
            if i % 20 == 0:  # Log every 20 updates
                ...
                logger.info(f"Volume: {volume:.1f}")
                logger.info(
